...
//   // Register ScrollTrigger plugin immediately at module level
...
//         // Hover Interaction Pattern (Scale & Opacity together using GSAP)
//         const onMouseEnter = () => {
//           gsap.to(item, {
//             scale: 1.05,
//             opacity: 1,
...
//         // STEP A: Animate INTO Center Focus (0% to 50% scroll progress)
//         tl.fromTo(
//           text,
//           {
//             filter: "blur(6px)",
...
//         // STEP B: Animate OUT OF Center Focus (50% to 100% scroll progress)
//         .to(
//           text,
//           {
//             filter: "blur(6px)",
...
//   return (
//     <div className="relative min-h-screen bg-[#050505] text-white font-sans overflow-x-hidden select-none">
//       <style jsx global>{`
//         .scroller-wrapper {
//           display: flex;

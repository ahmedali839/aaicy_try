...
//   return (
//     <main
//       className="flex flex-col items-center justify-center p-[15px] relative bg-[linear-gradient(180deg,rgba(244,244,245,1)_50%,rgba(250,250,250,1)_100%)] overflow-y-scroll"
...
//       className="flex max-w-[1200px] items-center justify-center gap-2.5 relative flex-[0_0_auto] w-full max-w-[1200px] mx-auto items-start justify-between gap-6 lg:gap-8
//   "
//       >
//         {/* left side */}
//         <section 
//         // className="flex flex-col max-w-[1200px] items-start justify-center gap-[13.9px] pt-20 pb-0 px-0 relative flex-1 grow"
//         className="flex flex-col max-w-300 items-start justify-center gap-[13.9px] pt-20 pb-0 px-0 relative flex-1 grow min-w-0"
//         >
//           <div className="inline-flex flex-col min-w-[700px] max-w-[700px] items-start relative flex-[0_0_auto]">
...
// <div className="flex max-w-[1200px] w-[1200px] items-start justify-center gap-2.5 relative flex-[0_0_auto]">
//   {/* LEFT SIDE (your existing section stays same) */}
//   <section className="flex flex-col max-w-[1200px] items-start justify-center gap-[13.9px] pt-20 pb-0 px-0 relative flex-1 grow">
//     {/* ...your left content exactly as it is... */}
//   </section>

//   {/* RIGHT SIDE (scrolling image viewport) */}
//   <div
//     className="
//       relative
//       w-[540px]             // /* a little bigger than 464 */
//       h-[calc(100vh-160px)] // /* visible height ~ screen */
//       overflow-hidden
//       flex-shrink-0
//       rounded-2xl
//     "
//     aria-hidden="true"
//   >
//     {/* This inner track moves upward forever */}
//     <div className="hero-scroll-track">
//       {/* Duplicate the same image twice for seamless loop */}
//       <img
//         src="/Hero/content.svg"
//         alt=""

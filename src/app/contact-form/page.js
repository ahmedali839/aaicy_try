  ...
  return (
    <div className="relative pt-32 pb-24 min-h-screen flex items-center justify-center">
      ...
      <div className="max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          ref={formRef}
          className="bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-3xl p-8 md:p-12 backdrop-blur-md shadow-2xl relative overflow-hidden"
        >
          {isSent ? (

...
//     logo: "https://aicy.company/logo.svg",
//     description:
...
export const metadata = {
  title: {
    template: "%s | AAICY – AI & Web Solutions",
    default:
      "AAICY – AI & Web Solutions | Custom Web Development, AI Agents & Automations",
  },
  description:
    "AAICY is an industry-leading agency specializing in high-performance web development, modern UI/UX design, and cutting-edge AI automations and autonomous agents. We build scalable, production-ready solutions for visionary businesses worldwide.",
  keywords: [
    "AAICY",
    "Web Development",
    "AI Agents",
  ...
  openGraph: {
    title: "AAICY – AI & Web Solutions",
    description:
      "Build the future with AAICY. Expert web development, stunning design, and intelligent AI automation tailored for scalable businesses.",
    url: "/",
    siteName: "AAICY",
    locale: "en_US",
    type: "website",

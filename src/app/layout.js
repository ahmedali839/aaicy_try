    ...
    >
      <head>
        ...
        />
         ...
         {/* 1. Google Fonts Properly Linked */}
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Inter+Tight:wght@400;500&family=Plus+Jakarta+Sans:wght@600&display=swap"
          rel="stylesheet"
        />

        {/* 2. Mandatory GSAP CDNs */}
        <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/gsap.min.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/ScrollTrigger.min.js"></script>
      </head>
      <body
        className={`${inter.className} ${interTight.variable} bg-white dark:bg-black text-black dark:text-white transition-colors duration-300 antialiased min-h-screen flex flex-col`}
        suppressHydrationWarning
      >
